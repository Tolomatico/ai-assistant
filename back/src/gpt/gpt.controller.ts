import { Body, Controller, Get, HttpStatus, Param, Post, Res, UseInterceptors, UploadedFile, ParseFilePipe, MaxFileSizeValidator } from '@nestjs/common';
import { FileInterceptor } from '@nestjs/platform-express';
import { GptService } from './gpt.service';
import { orthographyDto, ProsConsDiscusserDto, TextToAudioDto, TranslateDto, AudioToTextDto } from './dtos';
    ...
    @UseInterceptors(
      FileInterceptor('file',{
       ...
       @UploadedFile(
         new ParseFilePipe({
           validators: [
             new MaxFileSizeValidator({ maxSize: 1000 * 1024 * 5, message: "El archivo es mayor a 5mb" })
           ],
           fileIsRequired: true
         })
       ...
       if (!audioValidator.isValid(audioFile)) {
         throw new Error("Solo se permiten archivos de audio: mp3, mp4, m4a, aac, wav, ogg");
       }
