...
import { audioToTextCase, orthographyCase, prosConsDicusserCase, prosConsDicusserStreamCase, textToAudioCase, translateCase } from './use-cases';
...
async textToAudioGetter(fileId:string){
    ...
    const pathfile=path.resolve(
      ...
      if(!file) throw new NotFoundException("No se encontro el archivo de audio")
      return pathfile
}
